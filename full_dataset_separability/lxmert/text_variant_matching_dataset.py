...
class TextVariantMatchingDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.layer_idx < 9 or random.randint(0,1):
            caption_0_variants = self.all_texts[set_idx]['img0cap0lhs'][self.layer_idx]
            caption_1_variants = self.all_texts[set_idx]['img0cap1lhs'][self.layer_idx]
        else:
            caption_0_variants = self.all_texts[set_idx]['img1cap0lhs'][self.layer_idx]
            caption_1_variants = self.all_texts[set_idx]['img1cap1lhs'][self.layer_idx]
